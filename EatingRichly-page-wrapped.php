<?php /* Template Name: Eating Richly Wrapped Page */ get_header(); ?>
    ...
    <div class="main-content-i">
        <div class="content reading-mode-content side-padded-content">
            ...
            <article id="page-<?php the_ID(); ?>" <?php post_class( 'pluto-page-box'); ?>>
                <div class="post-body">
                    <?php /* <div class="single-post-top-features">
                    <div class="single-post-top-share">
                        ...
                        <div class="os_social-head-w">
                            <?php echo do_shortcode( '[os_social_buttons]'); ?>
                        </div>
                    </div>
        ...
        <?php endwhile; endif; if(get_field( 'enable_page_comments', 'options') && comments_open() || get_comments_number()){ comments_template(); } ?>
    </div>
    <?php os_footer(); ?>
</div>
</div>
